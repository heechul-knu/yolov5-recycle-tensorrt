...
class inferThread(threading.Thread):
    ...
    def run(self):
        results = []
        batch_image_raw, use_time, r_box, r_score, r_classid = self.yolov5_wrapper.infer(self.yolov5_wrapper.get_raw_image(self.image_path_batch))
        # print(self.image_path_batch)
        ...
        for i, img_path in enumerate(self.image_path_batch):
            ...
            r_box = r_box.cpu().numpy()
            r_score = r_score.cpu().numpy()
            r_classid = r_classid.cpu().numpy()
